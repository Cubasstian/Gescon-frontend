...
import { ConfirmedValidator } from '../../utils/pass.confirm';
...
export class InfoClientComponent implements OnInit {
  ...
  buildForm(): void {
    this.form = this.formBuilder.group({
      ...
      passwornew: ['', [Validators.required, Validators.minLength(4)]],
      passwordconfirm: ['', [Validators.required, Validators.minLength(4)]],
    }, { 
      validator: ConfirmedValidator('passwornew', 'passwordconfirm')
    });
  }
